      ...
      <section className="page-enter mx-auto flex w-full max-w-7xl flex-col gap-6 px-4 py-6 sm:px-6 md:px-10 lg:px-12">
        ...
        <dl className="grid gap-4 sm:grid-cols-3">
          <StatCard
            ...
            helper="Last 10 saved homeowner leads."
          />
          <StatCard
            label="Avg. savings"
            value={formatMoney(averageSavings)}
            helper="Average modeled annual savings."
          />
          <StatCard
            label="Queued follow-ups"
            value={queuedFollowUps.toString()}
            helper="Email and SMS sequence records."
          />
        </dl>
